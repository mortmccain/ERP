...
public sealed class SaleConfiguration : IEntityTypeConfiguration<Sale>
{
    public void Configure(EntityTypeBuilder<Sale> builder)
    {
        ...
        {
            address.Property(a => a.Street).HasColumnName("ShippingStreet").HasMaxLength(100).IsRequired();
            address.Property(a => a.City).HasColumnName("ShippingCity").HasMaxLength(200).IsRequired();
            address.Property(a => a.PostalCode).HasColumnName("ShippingPostalCode").HasMaxLength(10).IsRequired();
            address.Property(a => a.ExactAddress).HasColumnName("ExactShippingAddress").HasMaxLength(500).IsRequired();
        });
        ...
        builder.OwnsOne(s => s.SubTotal, money =>
        {
            ...
            money.Property(m => m.Currency).HasColumnName("SubTotalCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        builder.OwnsOne(s => s.SubTotalAfterLineDiscounts, money =>
        {
            money.Property(m => m.Amount).HasColumnName("SubTotalAfterDiscountAmount").HasColumnType("decimal(18,2)").IsRequired();
            money.Property(m => m.Currency).HasColumnName("SubTotalAfterDiscountCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        builder.OwnsOne(s => s.Discount, money =>
        {
            money.Property(m => m.Amount).HasColumnName("DiscountAmount").HasColumnType("decimal(18,2)").IsRequired();
            money.Property(m => m.Currency).HasColumnName("DiscountCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        builder.OwnsOne(s => s.TaxableAmount, money =>
        {
            money.Property(m => m.Amount).HasColumnName("TaxableAmountAmount").HasColumnType("decimal(18,2)").IsRequired();
            money.Property(m => m.Currency).HasColumnName("TaxableAmountCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        builder.OwnsOne(s => s.Tax, money =>
        {
            money.Property(m => m.Amount).HasColumnName("TaxAmount").HasColumnType("decimal(18,2)").IsRequired();
            money.Property(m => m.Currency).HasColumnName("TaxCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        builder.OwnsOne(s => s.Total, money =>
        {
            money.Property(m => m.Amount).HasColumnName("TotalAmount").HasColumnType("decimal(18,2)").IsRequired();
            money.Property(m => m.Currency).HasColumnName("TotalCurrency").HasMaxLength(3).IsUnicode(false).IsRequired();
        });

        // --- Discount Metadata ---
        builder.Property(s => s.DiscountPercentage).HasColumnType("decimal(5,2)");
        builder.Property(s => s.DiscountReason).HasMaxLength(500);

        // --- Tax Metadata ---
        builder.Property(s => s.TaxRate).HasColumnType("decimal(5,2)");
